 ...
 * Use the [OnBoardingScreenFragment2.newInstance] factory method to
...
class OnBoardingScreenFragment2 : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment OnBoardingScreenFragment2.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            OnBoardingScreenFragment2().apply {
