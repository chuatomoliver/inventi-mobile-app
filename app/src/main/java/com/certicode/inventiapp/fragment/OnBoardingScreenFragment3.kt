 ...
 * Use the [OnBoardingScreenFragment3.newInstance] factory method to
...
class OnBoardingScreenFragment3 : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment OnBoardingScreenFragment3.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            OnBoardingScreenFragment3().apply {
